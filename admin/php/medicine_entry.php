...
function getThreshold($unit_measurement) {
    global $conn;
    $sql = "SELECT threshold FROM medicine WHERE unit_measurement = ? LIMIT 1";
...
if (isset($_POST['submit'])) {
    ...
    $threshold = getThreshold($unit_measurement);
    ...
    ");
    $stmt->bind_param('ssssssssss', $description, $unit_measurement, $unit_price, $initial_stock, $stock_quantity, $unit_value, $lot_no, $expiration_date, $quantity_per_carton, $threshold);
    if ($stmt->execute()) {
